...
public int getYear() {
    ...
    public void setAllSalaryMaps(Map<Integer, Map<Integer, Salary>> employerSalaryMap) {
        ...
        // convert physical/proxy object(s) referenced by "employerSalaryMap" to reference ID(s)
        String employerSalaryMap_fpar = SerializationUtil.encodeWithDynamicTypeCheck(employerSalaryMap);
        form.param("employerSalaryMap", employerSalaryMap_fpar);

        klu__logger.info("[IRS] Calling service "+klu__serviceURI+
            "/setAllSalaryMaps with form: "+form.asMap());
    ...
    public void setEmployerSalaryListMap(List<Map<Integer, Salary>> employerSalaryListMap) {
        ...
        // convert physical/proxy object(s) referenced by "employerSalaryListMap" to reference ID(s)
        String employerSalaryListMap_fpar = SerializationUtil.encodeWithDynamicTypeCheck(employerSalaryListMap);
        form.param("employerSalaryListMap", employerSalaryListMap_fpar);

        klu__logger.info("[IRS] Calling service "+klu__serviceURI+
            "/setEmployerSalaryListMap with form: "+form.asMap());
    ...
    public void setEmployerSalaryListSet(List<Set<Salary>> employerSalaryListSet) {
        ...
        // convert physical/proxy object(s) referenced by "employerSalaryListSet" to reference ID(s)
        String employerSalaryListSet_fpar = SerializationUtil.encodeWithDynamicTypeCheck(employerSalaryListSet);
        form.param("employerSalaryListSet", employerSalaryListSet_fpar);

        klu__logger.info("[IRS] Calling service "+klu__serviceURI+
            "/setEmployerSalaryListSet with form: "+form.asMap());
    ...
    public void setEmployerArrayList(List<Integer>[] employerArrayList) {
        ...
        // convert physical/proxy object(s) referenced by "employerArrayList" to reference ID(s)
        String employerArrayList_fpar = SerializationUtil.encodeWithDynamicTypeCheck(employerArrayList);
        form.param("employerArrayList", employerArrayList_fpar);

        klu__logger.info("[IRS] Calling service "+klu__serviceURI+
            "/setEmployerArrayList with form: "+form.asMap());
    ...
    public void setEmployerArrayMap(Map<Integer, Employee>[] employerArrayMap) {
        ...
        // convert physical/proxy object(s) referenced by "employerArrayMap" to reference ID(s)
        String employerArrayMap_fpar = SerializationUtil.encodeWithDynamicTypeCheck(employerArrayMap);
        form.param("employerArrayMap", employerArrayMap_fpar);

        klu__logger.info("[IRS] Calling service "+klu__serviceURI+
            "/setEmployerArrayMap with form: "+form.asMap());
